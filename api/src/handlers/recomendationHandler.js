...
const createRecomendation = async (req, res) => {
    const { nameAndLastname, email, occupation, placeOfWork, message, linkedin } = req.body
    ...
    const newRecommendation = await recomendationAdd({ nameAndLastname, email, occupation, placeOfWork, message, linkedin })
